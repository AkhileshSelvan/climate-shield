...
2. **`tests/test_architecture.py` walks the import graph and fails the build** on any AI import —
   MUST-have **M15**. ✅ **Shipped 2026-08-17.** `trigger_engine.py` imports nothing at all, and a
   test loads it in isolation to prove it evaluates correctly with the rest of the app deleted.
